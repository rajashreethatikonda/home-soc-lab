...
## Overview
Built a home SOC lab to simulate a real-world cyberattack and detect it using a SIEM.
An attacker machine (Kali Linux) launches a brute force attack against a Windows 10 victim machine.
Splunk ingests Windows Event Logs and generates detection alerts.
